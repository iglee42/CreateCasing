...
public class ConfigurableGearboxRenderer extends KineticBlockEntityRenderer<GearboxBlockEntity> {

	public ConfigurableGearboxRenderer(BlockEntityRendererProvider.Context context) {
		super(context);
	}
	...
	protected void renderSafe(GearboxBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		for (Direction direction : Iterate.directions) {
			if (!be.getBlockState().getValue(ConfigurableGearboxBlock.getPropertyByDirection(direction))) continue;
