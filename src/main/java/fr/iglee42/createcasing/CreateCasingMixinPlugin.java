...
public class CreateCasingMixinPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.contains("FarmersDelight")) return LoadingModList.get().getModFileById("sliceanddice") != null && LoadingModList.get().getModFileById("farmersdelight") != null;
