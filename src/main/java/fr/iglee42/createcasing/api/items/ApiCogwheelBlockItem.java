...
public class ApiCogwheelBlockItem extends BlockItem {
	...
	public ApiCogwheelBlockItem(ApiCogwheelBlock block, Properties builder) {
		super(block, builder);
		large = block.isLarge;
		...
		public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
			...
			if (!ICogWheel.isLargeCog(state)) {
				...
				for (Direction dir : directions) {
					...
					if (!ApiCogwheelBlock.isValidCogwheelPosition(false, world, newPos, axis))
						continue;
		...
		public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
			...
			if (ICogWheel.isLargeCog(state)) {
				...
				for (Direction dir : directions) {
					...
					if (!ApiCogwheelBlock.isValidCogwheelPosition(true, world, newPos, dir.getAxis()))
						continue;
	...
	public abstract static class DiagonalCogHelper implements IPlacementHelper {
		...
		public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
			...
			for (Direction dir : directions) {
				...
				if (!ApiCogwheelBlock.isValidCogwheelPosition(ICogWheel.isLargeCog(state), world, newPos, axis))
					continue;
	...
	public static class IntegratedLargeCogHelper implements IPlacementHelper {
		...
		public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
			...
			for (Direction d : directions) {
				...
				if (!ApiCogwheelBlock.isValidCogwheelPosition(false, world, newPos, newAxis))
					return PlacementOffset.fail();

				return PlacementOffset.success(newPos, s -> s.setValue(ApiCogwheelBlock.AXIS, newAxis));
			}
		...
		public PlacementOffset getOffset(Player player, Level world, BlockState state, BlockPos pos,
			...
			for (Direction d : directions) {
				...
				return PlacementOffset.success()
					.at(newPos)
					.withTransform(s -> s.setValue(ApiCogwheelBlock.AXIS, newAxis));
			}
