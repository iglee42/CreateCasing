...
public class ModTiles {
    ...
    public static final BlockEntityEntry<KineticTileEntity> ENCASED_SHAFT = REGISTRATE
            ...
            .validBlocks(ModBlocks.RAILWAY_ENCASED_SHAFT,ModBlocks.COPPER_ENCASED_SHAFT)
    ...
    public static final BlockEntityEntry<PublicSimpleKinecticTileEntity> ENCASED_COGWHEEL = REGISTRATE
            ...
            .validBlocks(ModBlocks.RAILWAY_ENCASED_COGWHEEL,ModBlocks.COPPER_ENCASED_COGWHEEL)
    ...
    public static final BlockEntityEntry<PublicSimpleKinecticTileEntity> ENCASED_COGWHEEL_LARGE = REGISTRATE
            ...
            .validBlocks(ModBlocks.RAILWAY_ENCASED_COGWHEEL_LARGE,ModBlocks.COPPER_ENCASED_COGWHEEL_LARGE)
    ...
    public static final BlockEntityEntry<FluidPipeTileEntity> ENCASED_FLUID_PIPE = REGISTRATE
            ...
            .validBlocks(ModBlocks.ENCASED_ANDESITE_FLUID_PIPE,ModBlocks.ENCASED_BRASS_FLUID_PIPE,ModBlocks.ENCASED_RAILWAY_FLUID_PIPE)
            .register();
